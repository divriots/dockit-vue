<template>
  <VueLive :code="code" :layout="PlaygroundLayout" :components="components" :dataScope="dataScope"
    :checkVariableAvailability="false" :delay="500" v-on:error="(e: any) => handleError(e)"></VueLive>
</template>
